...
// Merge the changes into its local SQLite file when notification is posted
- (void)contentChange:(NSNotification *)note
{
    ...
    [[NSOperationQueue mainQueue] addOperationWithBlock:^{
        NSNotification *updateNote = [NSNotification
                                      notificationWithName:BNRFeedStoreUpdateNotification
                                                    object:nil];
...
- (id)init 
{
    self = [super init];
    if(self) {
        // This notification will be posted whenever the transaction
        // log is changed by another device
        ...
        // Construct the dictionary that tells Core Data where the transaction
        // should be stored
        ...
        NSURL *nosyncDir = [ubContainer
                            URLByAppendingPathComponent:@"feed.nosync"];
